...
namespace SmartAdminMvc.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
          //  AccountLoginModel usermodelo = new AccountLoginModel(); 
            AccountRegistrationModel usermodel = new AccountRegistrationModel();
           // usermodel.Email.Single(emp => emp.Email == id );
        ...
        AccountRegistrationModel cuenta = db
        ...
        */
        ...
        public async Task<ActionResult> Register(AccountRegistrationModel viewModel)
        {
          ...
          //  string Activo = viewModel.Activo;
